...
export const STYLES = {
  selectClass: "h-7 px-ui-control-x text-[13px] border border-ui-border rounded-ui-control bg-ui-control text-ui-text hover:bg-ui-control-hover focus-visible:border-brand-500 focus-visible:ring-1 focus-visible:ring-brand-500 focus-visible:ring-offset-0 outline-none transition-colors",
