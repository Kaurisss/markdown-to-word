    ...
    <Popover open={open} onOpenChange={(isOpen) => {
      ...
      <PopoverContent align="center" sideOffset={6} className="w-[var(--radix-popover-trigger-width)] p-3 z-[10000]">
        ...
        <div className="mt-3 flex items-center justify-between">
          ...
          <Button size="sm" className="bg-brand-600 hover:bg-brand-600 text-white" onClick={submit} disabled={disabled || !value.trim()}>
            生成样式
          </Button>
        </div>
      </PopoverContent>
