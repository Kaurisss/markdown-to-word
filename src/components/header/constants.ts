...
export const FONTS_CN = [
  'SimSun', 'NSimSun', 'FangSong', 'Microsoft YaHei', 'SimHei', 'KaiTi',
  'LiSu', 'YouYuan', 'STXihei', 'STSong', 'STFangsong', 'STKaiti',
  'STZhongsong', 'FZShuSong-Z01', 'FZXiaoBiaoSong-B05', 'DengXian',
];
export const FONTS_EN = [
  'Times New Roman', 'Arial', 'Georgia', 'Courier New',
  'Calibri', 'Cambria', 'Verdana', 'Tahoma',
  'Trebuchet MS', 'Garamond', 'Palatino Linotype', 'Consolas',
];
...
export const STYLES = {
  selectClass: "h-7 px-2 text-xs border border-gray-300 dark:border-dark-border rounded bg-white dark:bg-dark-element text-gray-900 dark:text-gray-200 hover:border-gray-400 dark:hover:border-gray-500 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-colors",
  ...
  inputClass: "h-7 px-2 text-xs border border-gray-300 dark:border-dark-border rounded bg-white dark:bg-dark-element text-gray-900 dark:text-gray-100 hover:border-gray-400 dark:hover:border-gray-500 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-colors",
  menuItemClass: "w-full text-left px-3 py-1.5 text-xs hover:bg-gray-100 dark:hover:bg-dark-element-hover flex items-center space-x-2"
};
