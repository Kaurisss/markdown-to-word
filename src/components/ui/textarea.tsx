...
function Textarea({ className, ...props }: React.ComponentProps<"textarea">) {
  return (
    <textarea
      data-slot="textarea"
      className={cn(
        "flex min-h-[60px] w-full rounded-lg border border-gray-200 dark:border-dark-border bg-white dark:bg-dark-element px-3 py-2 text-sm text-gray-900 dark:text-gray-100 shadow-sm transition-all outline-none",
