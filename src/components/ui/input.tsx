...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "flex h-9 w-full min-w-0 rounded-lg border border-gray-200 dark:border-dark-border bg-white dark:bg-dark-element px-3 py-1.5 text-sm text-gray-900 dark:text-gray-100 shadow-sm transition-all outline-none",
